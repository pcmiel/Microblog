...
public class FollowServiceTest {
	...
	public void testGetFollowingUsers() throws Exception {
		...
		List<BlogUser> userWithoutFollowing = followService
				.getFollowing(USER_NAME1);
		List<BlogUser> userWithFollowing = followService
				.getFollowing(USER_NAME2);
	...
	public void testGetUnollowingUsers() throws Exception {
		...
		List<BlogUser> userWithoutFollowing = followService
				.getUnfollowing(USER_NAME1);
		List<BlogUser> userWithFollowing = followService
				.getUnfollowing(USER_NAME2);
